            ...
            findPreference("notification")
                    .setOnPreferenceChangeListener(new Preference.OnPreferenceChangeListener() {
                        ...
                        public boolean onPreferenceChange(final Preference preference,
                            ...
                            if ((Boolean) newValue) {
                                manager.notify(StepSensorAcceleration.NOTIFICATION_ID,
                                        StepSensorAcceleration.getNotification(getActivity()));
                            } else {
                                manager.cancel(StepSensorAcceleration.NOTIFICATION_ID);
                            }
